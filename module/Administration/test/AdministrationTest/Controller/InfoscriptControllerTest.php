...
namespace AdministrationTest\Controller;

use AdministrationTest\Bootstrap;
use Zend\Mvc\Router\Http\TreeRouteStack as HttpRouter;
use Administration\Controller\InfoscriptController;
use Zend\Http\Request;
use Zend\Http\Response;
use Zend\Mvc\MvcEvent;
use Zend\Mvc\Router\RouteMatch;

class InfoscriptControllerTest extends \PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        ...
        $this->controller = new InfoscriptController();
...
// </editor-fold>
    ...
    public function testGetService(){
        ...
        $this->assertInstanceOf('Administration\Service\IService', $this->controller->getService('Infoscript'));
        $this->assertInstanceOf('Administration\Service\IService', $this->controller->getService('Anzeige'));
        $this->assertInstanceOf('Administration\Service\IService', $this->controller->getService('Url'));
        $this->assertInstanceOf('Administration\Service\IService', $this->controller->getService('Kunde'));
    }
